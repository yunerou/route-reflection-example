...
type ExampleReqParam struct {
	...
	Param1 string `path:"param1" doc:"this is param1"`
	Param2 string `path:"param2" doc:"this is param2"`
	// Documentation for Param2: this is param2
	Param3 int `query:"param3" doc:"this is param3"`
}

type ExampleReqBody struct {
	// Documentation for Field1: this is field1
	Field1 string `json:"field1" doc:"this is field1"`
